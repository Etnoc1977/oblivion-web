      ...
      <div className="min-h-screen bg-[#090c16] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-[#111422] border border-[#1e3a8a] rounded-2xl p-8">
            ...
            <p className="text-xs text-gray-500 mb-6">Use this key in your desktop app to connect to the platform.</p>
        ...
        <div className="bg-[#111422] border border-[#1e3a8a] rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">
              {isRegister ? 'Join the Oblion platform' : 'Sign in to Oblion'}
            </p>
          </div>
